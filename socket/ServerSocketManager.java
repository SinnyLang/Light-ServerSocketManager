...
public class ServerSocketManager {
    ...
    public void setWorkerImpl(Class workerImpl) throws NoSuchMethodException {
        this.workerImplClassCtor = workerImpl.getConstructor(SocketWrapper.class, int.class, MessageDispatcher.class);
    }

    public static void setServerLog(Logger logger){
        serverLog = logger;
    }
...
//        System.out.println(":"+serverThread.hashCode());
    ...
    public void accept() {
        serverLog.info("开启监听在端口{}", LISTEN_PORT);
        ...
        public void run() {
            ...
            while (!b){
                ...
                try {
                    ...
                    workers.add( (Worker) workerImplClassCtor.newInstance(socketWrapper, index++, dispatcher));
